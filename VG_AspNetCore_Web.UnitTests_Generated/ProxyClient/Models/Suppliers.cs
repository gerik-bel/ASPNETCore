...
namespace Swagger.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the Suppliers class.
        /// </summary>
        public Suppliers()
        {
            CustomInit();
        ...
        /// Initializes a new instance of the Suppliers class.
        /// </summary>
        public Suppliers(string companyName, int? supplierId = default(int?), string contactName = default(string), string contactTitle = default(string), string address = default(string), string city = default(string), string region = default(string), string postalCode = default(string), string country = default(string), string phone = default(string), string fax = default(string), string homePage = default(string), IList<Products> products = default(IList<Products>))
        {
